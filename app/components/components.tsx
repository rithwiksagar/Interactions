...
export function Header({ icon, title, description }: any) {
  return (
...
export function Phrase({ setView }: any) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function Key({ setView }: any) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function RemoveWallet({ setView }: any) {
  return (
    <div>
      <div className="px-2">
        <Header
...
export function DefaultView({ setView }: any) {
  return (
    <>
